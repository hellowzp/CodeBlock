...
typedef data_ptr_t data_copy_func(data_ptr_t);
typedef int compare_data_func(data_ptr_t, data_ptr_t);

typedef struct funcs{
	destory_data_func *data_destory;
	data_copy_func *data_copy;
	compare_data_func *data_compare;
} sidefuncs;
...
list_ptr_t list_alloc (destory_data_func *,compare_data_func *,data_copy_func *, data_ptr_t );
