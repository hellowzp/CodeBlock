...
//http://www.cplusplus.com/forum/general/30497/
#define _WIN32_IE 0x301 //or any number larger that 0x300
#include <windows.h>
#include <time.h>
...
//need to define a custom message so that the backbuffer
//can be resized to accomodate the toolbar
